...
Variables are great to perform arithmetic operations with. In this assignment, we have defined a variable `my_apples`. You want to define another variable called `my_oranges` and add these two together: `my_apples + my_oranges`.
